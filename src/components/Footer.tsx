        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/in/rafaelvilela/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <Linkedin className="h-5 w-5 hover:text-primary transition-colors" />
              </a>
              <a href="mailto:contato@rafaelvilela.com" aria-label="Email">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">contato@rafaelvilela.com</li>
              <li className="text-gray-300">+55 (31) 99999-9999</li>
