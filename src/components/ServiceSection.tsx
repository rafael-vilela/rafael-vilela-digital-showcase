    ...
    <section id={id} className="section bg-white">
      <div className="container-custom">
        ...
        <div className={cn(
          ...
          {/* On mobile, this will show second due to flex-col-reverse in the parent */}
          <div className="service-info animate-fade-up">
            ...
            {projectName && (
              <div className="mb-6">
                ...
                {projectUrl && (
                  <a href={projectUrl} target="_blank" rel="noopener noreferrer" className="inline-block">
                    <Button variant="outline" className="hover-transform text-base bg-gray-300 hover:bg-gray-200">
                      {ctaText || "Visualizar Projeto"}
                    </Button>
                  </a>
                )}
              </div>
          ...
          {/* On mobile, this will show first due to flex-col-reverse in the parent */}
          <div className={cn(
            "service-image animate-fade-up animate-delay-200", 
