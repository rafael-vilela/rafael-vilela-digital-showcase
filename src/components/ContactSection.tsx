          ...
          <Card className="shadow-lg border-none animate-fade-up">
            <CardContent className="p-6">
              ...
              <div className="space-y-5">
                <div>
                  <Input type="text" placeholder="Seu nome" name="name" value={formData.name} onChange={handleChange} className="w-full" />
                </div>
                <div>
                  <Input type="text" placeholder="Segmento do seu negócio" name="segment" value={formData.segment} onChange={handleChange} className="w-full" />
                </div>
                <div>
                ...
                <Button onClick={handleWhatsAppRedirect} className="btn-primary w-full">
            ...
            <div className="space-y-6">
              <a href="mailto:rafavpereira1@gmail.com" className="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-all hover-transform">
                ...
                <div>
                  ...
                  <p className="text-gray-700">rafaelvilelaservicos@gmail.com</p>
                </div>
              </a>
              
              <a href="https://wa.me/12982127115" target="_blank" rel="noopener noreferrer" className="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-all hover-transform">
                <div className="h-12 w-12 bg-primary/20 rounded-full flex items-center justify-center mr-4">
