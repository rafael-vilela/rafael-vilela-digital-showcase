...
const Hero = () => {
  const typingPhrases = ["experiências digitais", "resultados concretos", "projetos memoráveis", "soluções personalizadas", "crescimento real"];
  ...
  return <section id="home" className="min-h-screen flex items-center pt-16 md:pt-20 bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6 md:mt-8">
              ...
              <a href="#contact" className="btn-outline hover-transform text-center py-2 md:py-3 text-sm sm:text-base" onClick={e => {
              e.preventDefault();
          ...
          <div className="animate-fade-in animate-delay-200 flex justify-center">
            <div className="relative w-full max-w-md mx-auto">
              ...
              <div className="bg-gradient-to-br from-white to-gray-100 p-4 sm:p-6 rounded-xl shadow-xl">
                <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Web Development" className="rounded-lg w-full h-auto object-cover" />
              </div>
            </div>
          </div>
        </div>
